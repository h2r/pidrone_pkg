...
def affineToTransform(affine, summed_transform):
    ...
    if affine is not None:
        ...
        transformation.translation.x = int(affine[0, 2] - t_offsetx) #* summed_transform.pose.translation.y
        transformation.translation.z = int(affine[1, 2] - t_offsetz) #* summed_transform.pose.translation.y
        # calc rotation
        affine[:, 0] /= scalex
        affine[:, 1] /= scalez
