...
pospub = rospy.Publisher('/pidrone/homo_fixed_pos', PoseStamped, queue_size=1)
...
if __name__ == "__main__":
    rospy.init_node("homography_flight_first")
    rospy.Subscriber("/pidrone/camera", Image, img_callback)
    rospy.Subscriber("/pidrone/homo_pos", PoseStamped, height_callback)
    rospy.spin()
