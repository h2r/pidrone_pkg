...
class VarianceSmoother():
    ...
    def step(self, data):
        ...
        self.NR_alpha = self.renorm(self.NR_sigma2) # update alpha based on variance
        ...
        if self.num_rejects > 30:       # if we've rejected too many readings, snap to backup
...
class OldSmoother():
    def __init__(self, pub):
        ...
        self.fixed_alpha = 0.1
        self.alpha = 0.5
        self.alpha_range = np.array([0.4,0.9])
        self.rng_msg = Range()
        self.num_readings = 0
