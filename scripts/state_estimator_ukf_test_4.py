...
class StateEstimation(object):
    ...
    def initialize_ros(self):
        ...
        '''
        self.node_name = 'state_estimator_ukf_test_4'
    ...
    def imu_data_callback(self, data):
        ...
        if self.ready_to_filter:
            ...
            self.ukf.P[6, 6] = self.measurement_cov_yaw[0]
            self.got_imu = True
    ...
    def check_if_ready_to_filter(self):
        self.ready_to_filter = (self.got_ir and self.got_optical_flow and self.got_imu)
