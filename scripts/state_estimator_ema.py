...
#TODO TEST jroy1: lol
    ...
    def filter_pose(self, pose):
        ...
        # jroy1: Should be a class variable
        alpha = 0.2
    ...
    def filter_twist(self, twist):
        ...
        # jroy1: Should be a (differently named) class variable
        alpha = 0.2
        alpha = 0.4
    ...
    # jroy1: I'm noticing this function is being used in multiple files with
    # different thresholds. Let's abstract it to a file containing generic
    # helpers
