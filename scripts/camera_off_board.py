...
class AnalyzePhase:
    ...
    def __init__(self):
        ...
        self.lr_pid = PIDaxis(12.5, 0.001, 0.0023, midpoint=0, control_range=(-5.0, 5.0))
        self.fb_pid = PIDaxis(12.5, 0.001, 0.0023, midpoint=0, control_range=(-5.0, 5.0))

        self.detector = cv2.ORB(nfeatures=500, scoreType=cv2.ORB_FAST_SCORE)  # FAST_SCORE is a little faster to compute
